...
$id=  $_GET['id'];
    ...
    // echo $t;
     ...
     //have to change in future 
        ...
        $time=strtotime($r);
    // echo $demand;
       $sel="insert into request (user_id,user_name,user_img,active_request,borrow_amount,detail_user,type,acvt_date,add_time) values('$id','$uname','','1','$demand','$detail','$t',NOW(),'$time')";
